...
export function WalletsTab() {
  ...
  return (
    <div className="wallets-v2-container" role="region" aria-label="Quản lý ví và tài khoản">
      ...
      {/* ── 3. Khu vực Ví đã lưu trữ (Archived Wallets Accordion) ── */}
      {archivedWallets && archivedWallets.length > 0 && (
        <div
          className="wallet-archived-section"
          style={{
            marginTop: '28px',
            borderRadius: '12px',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <div
                style={{
                  ...
                  height: '32px',
                  borderRadius: '8px',
                  backgroundColor: 'var(--surface-card, rgba(0, 0, 0, 0.05))',
                  display: 'flex',
                  alignItems: 'center',
              ...
              <div style={{ textAlign: 'left' }}>
                <strong style={{ fontSize: '0.95rem' }}>Ví đã lưu trữ ({archivedWallets.length})</strong>
                <div style={{ fontSize: '0.8rem', color: 'var(--text-secondary, #6b7280)' }}>
                  Các ví đã đóng không còn sử dụng nhưng vẫn bảo toàn lịch sử giao dịch
                </div>
              </div>
            </div>
            <svg
              ...
              strokeLinejoin="round"
              style={{
                transform: isArchivedSectionExpanded ? 'rotate(180deg)' : 'rotate(0deg)',
              ...
              {archivedWallets.map((aw) => (
                <div
                  ...
                  style={{
                    ...
                    padding: '12px 14px',
                    borderRadius: '8px',
                    backgroundColor: 'var(--surface-card, rgba(0, 0, 0, 0.03))',
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <span
                          style={{
                            ...
                            padding: '1px 6px',
                            borderRadius: '4px',
                            backgroundColor: 'var(--color-neutral-bg, rgba(107, 114, 128, 0.15))',
                            color: 'var(--text-secondary, #6b7280)'
                          }}
                        >
                          Đã lưu trữ
